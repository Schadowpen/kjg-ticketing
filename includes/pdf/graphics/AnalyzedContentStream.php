...
use KjG_Ticketing\pdf\graphics\operator\BeginCompatibilityOperator;
...
use KjG_Ticketing\pdf\graphics\operator\EndCompatibilityOperator;
...
use KjG_Ticketing\pdf\graphics\operator\MarkedContentOperator;
...
use KjG_Ticketing\pdf\graphics\operator\OperatorMetadata;
...
use KjG_Ticketing\pdf\graphics\operator\ShadingOperator;
...
use KjG_Ticketing\pdf\graphics\operator\UnknownOperator;
    ...
    private function expandDeletableRange( Range &$range ) {
        ...
        do {
            ...
            if ( $prevOperator->isRenderingOperator() || $prevOperator instanceof PopGraphicsStateOperator ) {
                return;
            } // Bereich zwischen dem letzten vorherigen RenderingOperator oder Q und Q wird gelöscht
