...
class ObjectParser {
     ...
     *
     * @param StringReader $stringReader Reader zum fortlaufenden Lesen des Strings. Seine Position wird während des Parsens verwendet.
     ...
     */
    public function __construct( StringReader $stringReader, int $objectStartPos = null ) {
     ...
     * @return StringReader
     */
    public function getStringReader(): StringReader {
